package com.robin.commonUi.customview.progress;
...
import com.robin.commonUi.BuildConfig;
import com.robin.commonUi.R;
import com.robin.commonUi.customview.progress.util.MiscUtil;
import com.robin.commonUi.customview.progress.util.ProgressConstant;
...
public class CircleProgress extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        mContext = context;
        mDefaultSize = ConvertUtils.dp2px(ProgressConstant.DEFAULT_SIZE);
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        antiAlias = typedArray.getBoolean(R.styleable.CircleProgressBar_antiAlias, ProgressConstant.ANTI_ALIAS);
        ...
        mHintSize = typedArray.getDimension(R.styleable.CircleProgressBar_hintSize, ProgressConstant.DEFAULT_HINT_SIZE);

        mValue = typedArray.getFloat(R.styleable.CircleProgressBar_value, ProgressConstant.DEFAULT_VALUE);
        mMaxValue = typedArray.getFloat(R.styleable.CircleProgressBar_maxValue, ProgressConstant.DEFAULT_MAX_VALUE);
        //内容数值精度格式
        ...
        mValueSize = typedArray.getDimension(R.styleable.CircleProgressBar_valueSize, ProgressConstant.DEFAULT_VALUE_SIZE);
        ...
        mUnitSize = typedArray.getDimension(R.styleable.CircleProgressBar_unitSize, ProgressConstant.DEFAULT_UNIT_SIZE);

        mArcWidth = typedArray.getDimension(R.styleable.CircleProgressBar_arcWidth, ProgressConstant.DEFAULT_ARC_WIDTH);
        mStartAngle = typedArray.getFloat(R.styleable.CircleProgressBar_startAngle, ProgressConstant.DEFAULT_START_ANGLE);
        mSweepAngle = typedArray.getFloat(R.styleable.CircleProgressBar_sweepAngle, ProgressConstant.DEFAULT_SWEEP_ANGLE);

        mBgArcColor = typedArray.getColor(R.styleable.CircleProgressBar_bgArcColor, Color.WHITE);
        mBgArcWidth = typedArray.getDimension(R.styleable.CircleProgressBar_bgArcWidth, ProgressConstant.DEFAULT_ARC_WIDTH);
        ...
        mAnimTime = typedArray.getInt(R.styleable.CircleProgressBar_animTime, ProgressConstant.DEFAULT_ANIM_TIME);
