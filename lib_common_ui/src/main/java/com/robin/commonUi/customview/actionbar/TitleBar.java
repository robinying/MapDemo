...
package com.robin.commonUi.customview.actionbar;
...
import com.robin.commonUi.customview.alpha.XUIAlphaImageView;
import com.robin.commonUi.customview.alpha.XUIAlphaLinearLayout;
import com.robin.commonUi.customview.alpha.XUIAlphaTextView;
import com.robin.commonUi.customview.textview.AutoMoveTextView;
...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBarHeight = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_barHeight, ConvertUtils.dp2px(60));
        mImmersive = typedArray.getBoolean(R.styleable.TitleBar_tb_immersive, false);

        mActionPadding = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_actionPadding, ConvertUtils.dp2px(8));
        mSideTextPadding = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_sideTextPadding, ConvertUtils.dp2px(15));
        mCenterGravity = typedArray.getInt(R.styleable.TitleBar_tb_centerGravity, CENTER_CENTER);

        mSideTextSize = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_sideTextSize, ConvertUtils.sp2px(18));
        mTitleTextSize = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_titleTextSize, ConvertUtils.sp2px(21));
        mSubTitleTextSize = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_subTitleTextSize, ConvertUtils.sp2px(12));
        mActionTextSize = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_actionTextSize, ConvertUtils.sp2px(18));

        mSideTextColor = typedArray.getColor(R.styleable.TitleBar_tb_sideTextColor, Color.WHITE);
        mTitleTextColor = typedArray.getColor(R.styleable.TitleBar_tb_titleTextColor, Color.WHITE);
        mSubTitleTextColor = typedArray.getColor(R.styleable.TitleBar_tb_subTitleTextColor, Color.WHITE);
        mActionTextColor = typedArray.getColor(R.styleable.TitleBar_tb_actionTextColor, Color.WHITE);
        ...
        mDivideHeight = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_dividerHeight, ConvertUtils.dp2px(1));
    ...
    private void initView(Context context) {
        ...
        mSubTitleText.setPadding(0, ConvertUtils.dp2px(2), 0, 0);
    ...
    public TitleBar setBackImageResource(int resId) {
        if (resId != 0) {
            ...
            mLeftImageResource.setBounds(0, 0, ConvertUtils.dp2px(12), ConvertUtils.dp2px(22));
    ...
    protected View inflateAction(Action action) {
        ...
        if (TextUtils.isEmpty(action.getText())) {
            ...
            //字体大于等于16sp自动加粗
            if (ConvertUtils.px2dp(mActionTextSize) >= 16) {
