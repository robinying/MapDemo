...
import com.robin.mapdemo.databinding.FragmentAmapRouteBinding

class AmapRouteFragment:BaseFragment<BaseViewModel,FragmentAmapRouteBinding>() {
    private lateinit var mAMap: AMap
    override fun layoutId(): Int {
        return R.layout.fragment_amap_route
    }
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        mAMap.setOnMapLoadedListener {
            LogUtils.d("robinTest", "Amap Route Loaded")
        }
    }
}