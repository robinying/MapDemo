...
import com.robin.mapdemo.databinding.FragmentAmapOtherBinding

class AmapOtherFragment:BaseFragment<BaseViewModel,FragmentAmapOtherBinding>() {
    private lateinit var mAMap: AMap
    override fun layoutId(): Int {
       return R.layout.fragment_amap_other
    }
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        mAMap.setOnMapLoadedListener {
            LogUtils.d("robinTest", "Amap Other Loaded")
        }
    }
}